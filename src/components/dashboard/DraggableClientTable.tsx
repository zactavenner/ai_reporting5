                        ...
                        {(m.totalCalls || 0) === 0 && (m.totalAdSpend || 0) > 0 && (() => {
                          ...
                          if (!hasGHL) return (
                            <Tooltip>
                              ...
                              <TooltipContent side="top" className="text-xs max-w-[220px]">
                                No GHL credentials — add GHL API key & location ID to sync booked/show calls
                              </TooltipContent>
                            </Tooltip>
                          );
                          if (!hasCalendars) return (
                            <Tooltip>
                              ...
                              <TooltipContent side="top" className="text-xs max-w-[220px]">
                                No tracked calendars configured — calendars will be auto-discovered on next sync, or add calendar IDs in client settings
                              </TooltipContent>
                            </Tooltip>
                          );
                          return null;
